...
impl<T: Abomonation, D: Abomonation> EventPusher<T, D> for EventProducerCore<T, D> {
...
impl<T: Abomonation, D: Abomonation> EventIterator<T, D> for EventConsumerCore<T, D> {
